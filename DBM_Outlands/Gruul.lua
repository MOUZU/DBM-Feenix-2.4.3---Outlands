...
Gruul:AddBarOption("Possible Silence")

function Gruul:OnCombatStart(delay)
	self.Grows = 0;	
	self:ScheduleSelf(110 - delay, "SilenceSoon");
	self:StartStatusBarTimer(115 - delay, "Possible Silence", "Interface\\Icons\\Spell_Holy_ImprovedResistanceAuras");	
...
function Gruul:OnEvent(event, arg1)
	...
	elseif event == "SPELL_AURA_APPLIED" then
		...
		elseif arg1.spellId == 36297 then
			...
			self:ScheduleSelf(15, "SilenceSoon");
			self:StartStatusBarTimer(20, "Possible Silence", "Interface\\Icons\\Spell_Holy_ImprovedResistanceAuras");
		end
    ...
    elseif event == "Slam" then
        ...
        self:ScheduleSelf(56, "SlamSoon");
        self:EndStatusBarTimer("Ground Slam");
        self:StartStatusBarTimer(61, "Ground Slam", "Interface\\Icons\\Spell_Nature_ThunderClap");
	end
end